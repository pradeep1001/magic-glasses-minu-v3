...
export default function QuizPage() {
  ...
  const questions = [
    ...
    {
      question: "Which color is most often used for highlighting edges?",
      options: ["Red", "Green", "Blue"],
      answer: "Blue",
    },
    {
      question: "Which technique is commonly used in image edge detection?",
      options: ["Sobel Filter", "Gaussian Blur", "Histogram Equalization"],
      answer: "Sobel Filter",
    },
  ]
